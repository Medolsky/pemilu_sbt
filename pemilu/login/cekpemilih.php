 ...
 $pilih = "INSERT INTO hasilpemilihan (username,yangdipilih) values ('$username','$yangdipilih')";
 $daftar = mysqli_query($koneksi, $pilih);
 if ($daftar){
    echo "<script>alert('Terima kasih telah mengikuti pemilihan calon ketua sbt!')</script>";
